...
plt.plot(x,day_avg, color = "dodgerblue", linestyle = '-', label = "2020: 7 day average", linewidth = 3)
plt.axvline(x=71, color = 'red', linestyle = '--')
plt.xticks([0,31,59,90,120,151,181,212,243,273,304,334], ["January 01","February 01","March 01", "April 01","May 01","June 01","July 01","August 01", "September 01", "October 01", "November 01", "December 01"], rotation = 50)
plt.xlim([0,len(frequencies1)])
plt.text(75, 10000, 'March 11, 2020: WHO declared pandemic', color = 'red')
...
plt.xticks([0,31,59,90,120,151,181,212,243,273,304,334], ["January 01","February 01","March 01", "April 01","May 01","June 01","July 01","August 01", "September 01", "October 01", "November 01", "December 01"], rotation = 50)
plt.xlim([0,len(frequencies1)])
plt.text(75, 1660, 'March 11, 2020: WHO declared pandemic', color = 'red')
